      ...
      <div className="flex flex-col lg:flex-row justify-between gap-6">
        ...
        <div className="w-full lg:w-[40%] flex justify-center">
          <img
            ...
            alt="Banner"
            className="w-full max-w-[550px] h-auto lg:h-[750px] object-cover rounded-2xl"
          />
        </div>
        ...
        <div className="w-full lg:w-[60%]">
          <Heading
            text={"Who We Are"}
            as={"p"}
            className={"text-[24px] sm:text-[30px] hover:text-pink-600 text-center mt-8"}
          />
          <Heading
            text={
            ...
            as={"p"}
            className={"text-[14px] sm:text-[15px] mt-4 hover:text-pink-600 text-justify"}
          />
          <Heading
            text={"✨ GloreBD-এর সাথে ফ্যাশনে পা রাখুন নতুন দিগন্তে! ✨"}
            as={"p"}
            className={"text-[24px] sm:text-[30px] hover:text-pink-600 text-center mt-10"}
          />
          <Heading
            text={
