        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-1/2">
            <img
              src={imageUrl}
              alt={product.name}
              className="w-full h-auto object-contain max-h-[500px] rounded-md"
            />
          </div>

          {/* Details Section */}
          <div className="w-full lg:w-1/2 lg:sticky lg:top-6 max-h-screen overflow-auto p-4 bg-white rounded-md shadow">
            ...
            <p className="text-2xl sm:text-3xl text-blue-700 font-extrabold mb-4">
              ৳ {product.price}
            </p>
            ...
            <button
              ...
              className="bg-blue-600 text-white py-3 rounded hover:bg-blue-700 transition w-full text-base sm:text-lg font-semibold mb-2"
            >
              অর্ডার করুন
            </button>
